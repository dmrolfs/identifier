...
//  }
  ...
  object akka extends SimpleModule {
    ...
    override val version = "2.6.5"
    def all: Seq[ModuleID] = Seq( actor, stream, cluster, clusterSharding, persistence, remote, slf4j )
  ...
  object logging {
    def all = Scope.provided( logback.core, logback.classic, slf4j, log4jOverSlf4j )
  ...
  object metrics extends SimpleModule {
    ...
    object scala extends SimpleModule {
      ...
      override def version: String = "4.1.5"
